                ...
                httpSecurity.csrf(AbstractHttpConfigurer::disable)
                                .authorizeHttpRequests(authorize -> {
                                        authorize.requestMatchers(
                                                        ...
                                                        .requestMatchers(antMatcher(HttpMethod.GET, "/contactos"))
                                                        .hasAnyRole(UserRole.USER.name(), UserRole.ADMIN.name())
                                                        .requestMatchers(antMatcher(HttpMethod.DELETE, "/contactos"))
                                                        .hasRole(UserRole.ADMIN.name())
                                                        .requestMatchers(antMatcher(HttpMethod.POST, "/contactos"))
                                                        .hasRole(UserRole.ADMIN.name())
                                                        .requestMatchers(antMatcher(HttpMethod.PUT, "/contactos"))
                                                        .hasRole(UserRole.ADMIN.name())
